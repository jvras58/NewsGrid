...
def test_create_user_success(mock_create, client, mock_username):
...
@patch("app.api.user.controller.AuthService.create_user")
def test_create_user_failure(mock_create, client, mock_username):
...
def test_list_users(mock_list, client, mock_username):
...
def test_revoke_user_success(mock_revoke, client, mock_username):
...
@patch("app.api.user.controller.AuthService.revoke_user")
def test_revoke_user_not_found(mock_revoke, client, mock_username):
